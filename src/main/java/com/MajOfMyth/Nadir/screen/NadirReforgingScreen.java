package com.MajOfMyth.Nadir.screen;
...
public class NadirReforgingScreen extends AdventureContainerScreen<NadirReforgingMenu> {
    ...
    public NadirReforgingScreen(NadirReforgingMenu menu, Inventory inv, Component title) {
